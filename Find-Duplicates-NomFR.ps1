<#
.SYNOPSIS
    Trouve les doublons dans la colonne "Nom FR" et exporte toutes les lignes correspondantes
...
.EXAMPLE
    .\Find-Duplicates-NomFR.ps1 -FilePath "fichier.xlsx"
#>
...
if ($OutputPath -eq "") {
    ...
    $OutputPath = Join-Path $fileDir "$fileName`_Doublons_NomFR.xlsx"
}

Write-Host "========================================"  -ForegroundColor Cyan
Write-Host "RECHERCHE DES DOUBLONS - NOM FR" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
try {
    ...
    foreach ($dup in ($duplicates | Sort-Object)) {
